...
import com.wenner.pontointeligente.api.dto.CadastroPFDto;
...
public class CadastroPFController {
	...
	public ResponseEntity<Response<CadastroPFDto>> cadastrar(@Valid @RequestBody CadastroPFDto cadastroPFDto,
		...
		if (result.hasErrors() ) {
			log.error("Validando erros de cadastro PF: {}", result.getAllErrors() );
	...
	/**
	 * Verifica se a empresa já está cadastrada e se o funcionario não existe no base de dados
	 * 
	 * @param cadastroPFDto
	 * @param result
	 * */
