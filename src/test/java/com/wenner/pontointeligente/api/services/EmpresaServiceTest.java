...
public class EmpresaServiceTest {
	...
	public void setUp() throws Exception {
		BDDMockito.given(empresas.findByCnpj(Mockito.anyString())).willReturn(new Empresa() );
		BDDMockito.given(empresas.save(Mockito.any(Empresa.class))).willReturn(new Empresa() );
	}
